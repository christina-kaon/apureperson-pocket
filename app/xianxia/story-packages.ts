...
const fogmoorManorPassionStyle = `英式庄园 × 激情做恨（张力档）× 西幻龙王。影视化长镜头写法：把本轮写成可以直接拍摄的连续镜头，不是小说叙述。
...
【西幻龙王感与霸总做派】龙王厄尔宁上岸时是人形，但世界要为他让路：他进门时潮声换方向、壁炉的火矮半寸、银器发出细微的共振；金瞳在暗处竖一瞬，颈侧金鳞纹在领口下若隐若现，体温偏低，握过的杯子外壁结一层薄雾。他不用敬语，只用陈述句——不问价直接买、不请求直接宣布、把整座庄园的规矩当作可以随手翻阅的东西，却从不高声、从不粗鲁：他的失礼是另一种礼仪，是王座的礼仪。对你用"我的"，对上校用"这位先生"，对你腹中的孩子用"它"然后改口用"他"。霸总感来自绝对的确定与从容的占有欲，不来自吼叫或炫富；他最锋利的动作是把一件昂贵的东西放在你面前然后不看它。

【电压：激情做恨——只在对抗性亲密的独处场景启用，且封顶张力档】适用条件：两人身份对立（恨海的人与来自海的人；龙王与逃走的海妻），且现场无第三人。启用后写法：性张力写成一场谁先认输的战争——身体先于言语（抓握手腕、抬起下巴、把人按在门板或书桌边、逼近到呼吸可闻、不许对方移开视线），对白以反问与逼问为主、锋利直白、带嘲讽与掌控（"承认吧""你在发抖""你跑了九天，就为了让我亲自来接？"），嘲笑对方的动情反应，强调"你输了"。羞耻与渴望必须同框，用否定意志来凸显身体的诚实。龙王的做恨是王者的：不急、不狠、每一步都像在收回自己的东西；上校的做恨是军人的：短促、克制、每一次逼近都在与自己的教养打仗。孕身是这场战争里唯一的停火线：任何一方的手落到腹部，进攻必须停——胎动是比座钟更硬的打断。张力档封顶：可写抓握、逼近、体温、呼吸、咬唇、失神一瞬、衣料摩擦与被按住的手腕，不写性行为过程与器官；镜头在临界处切走（换镜头到座钟、窗外的潮声、被撞歪的相框）。

【融合规则】越体面越危险：庄园礼仪每被打破一寸，电压升一档——一句"恐怕这不太体面"在对抗性亲密语境里就是挑衅；解开一颗袖扣比脱去外衣更响。做恨之后必须回到体面：下一镜必有整理领口、重新倒茶、恢复敬称的"复位"动作，用复位的僵硬暴露方才的失控；龙王的复位是把杯子放回原处、让潮声退回窗外。
...
【文字长镜头】每条narration是一个镜头，镜头内用空间介词连贯移动，禁止镜头内跳切；每个空间段落三层景深，始终留一条画外音（潮声、座钟、楼下厨房的锅盖），提醒世界比画面大。

【白描铁律】只写镜头拍得到、话筒录得到的：动作、位置、光影、声音、可见的神态。禁止心理转述（"她想起""他意识到"一律违规，内心走os气泡）、禁止隐喻与煽情形容词堆叠（"仿佛""宛如""某种"慎用）、禁止总结与升华。玩家的原话不得以旁白形式复述或加以形容（不许写"你那一声平静的'哦'"之类替玩家定调的句子）——玩家说过的话只作为已发生的事实被他人回应。
...
【感官先行与群像内核】每段单一主导感官领起（触觉或听觉优先），气味温度有来源有落点；同一回合相近意象不重复。人物带各自目标入画、动作改变谈话而非装饰谈话；哈洛太太的秩序感底下是护短，不写成刻薄管家；塞林的漫不经心是盐渍的伤口，不写成纯反派；梅格婆婆是渔村产婆，说话直、手更直；克拉丽莎的刻度底下是怕被替代的少女。

仅用于校准镜头语言的范例（不得挪用剧情）：
1. 早餐室的银盖还没揭，座钟指着八点差七分。雨顺着落地窗的铅条往下走，把庭园的紫杉切成一格一格。管家把托盘放下时，杯碟之间没有一声碰响——这是她三十年的手艺。楼下厨房传来锅盖落下的一声，然后是长久的安静。
...
3. 门开的时候，壁炉里的火矮了半寸。他没有看屋里的任何人，先看了一眼座钟，像在核对这里的时间是否值得他遵守。"这座房子，"他说，把手套一只一只脱下来放在银托盘上，"临海的一面，我买了。"管家的托盘第一次发出了声音。`;

const fogmoor: XianxiaStory = {
  id: "fogmoor-tide",
  title: "雾角海妻",
  subtitle: "潮汐篇",
  logline: "一个从深渊王廷逃出来的人鱼，怀着龙王的孩子叩响了一座恨海的庄园的门；庄园主收留了她——然后龙王亲自上岸，买下了这座庄园临海的一面。",
  accent: "#7f97a6",
  playerRole: {
    id: "nerys",
    name: "奈莉丝",
    displayRole: "雾角庄园的不速之客·自称海难寡妇奈莉·格雷",
    fixedCore: "你是深渊王廷的人鱼，龙王厄尔宁的海妻——龙王的血脉只能由海族之外的躯体孕育，你被选中、被娶，如今怀着他的孩子，约六个月，腹部尚能用束腰与披肩遮住。九日前你逃上岸，化形为人。你懂潮汐、能在水中呼吸、歌声可安抚海兽；在陆地上，退潮时双腿刺痛，孕吐吐出的是盐水；每逢大潮胎动如潮涌、腰侧浮鳞，必须浸海水一夜，否则母子皆危。海族的历法算得清楚：孩子将在冬至大潮临盆。",
    baselineTendency: "深渊王廷养出的骄傲与警觉——这是可供玩家采用或反向选择的表演底色，不代表本轮一定戒备、冷淡或藏话。",
    freeAgency: "你可以决定对上校坦白多少、如何面对亲自上岸的龙王、让孩子在海里还是岸上出生，以及在大潮之夜站在潮的一边、岸的一边，还是两者之间。",
  },
  introduction: {
    time: "维多利亚时代晚期，秋末，大潮前的第九日",
    place: "英格兰西南海岸，悬崖上的雾角庄园",
    world: "陆上人早已不信海族，只有沿海的老人还记得'海妻'——古老家族与海族的旧契约：娶一位海妻，换一代人的风平浪静。雾角庄园的艾什福德家曾是签过契约的家族之一。海底另有一套秩序：深渊王廷统治潮汐，龙王厄尔宁的血脉只能借海族之外的躯体延续，海妻是容器，孩子是王廷的财产。契约里有一行没人愿念出口的话：龙裔必须在海中出生，否则两界皆失——母亲死于岸，海溃于礁。龙王极少上岸——他上岸时，潮汐会跟着他走。",
    situation: "九日前的暴风夜，你叩响了雾角庄园的门。埃德蒙·艾什福德上校——退役皇家海军、五年前丧妻于海难、全郡都知道他恨海——收留了你，以'海难寡妇奈莉·格雷'的身份。庄园的规矩接住了你：早餐八点、晚祷九点、寡妇不必赴宴。今晨退潮，你的小腿开始刺痛；你在盥洗室吐出的是盐水，哈洛太太收走盆时手在盆沿停了半息；她替你系披肩时，指尖在你腰侧的束带上又停了半息。上校在读报，报上说礁石外的海昨夜'自己亮了'，还说一位从伦敦来的'船东'一夜买尽了亮海湾所有渔家的船。",
    objective: "先在庄园的规矩里站稳，别让腰侧的第一片鳞和一盆盐水把你逐出这道门；再弄清上校为什么收留你——他看你的眼神不像看一个寡妇。大潮在七天后，你得决定到时候去浸海还是让鳞片浮上来；而那位买下所有船的'船东'，你不必见到就知道他是谁——他从不派人来接，他亲自来。",
  },
  threeAct: [
    "藏身与规矩：你在英式庄园的秩序里藏一个正在随潮异变的孕身，上校的克制与你的警觉互相试探——他恨海，而你就是海。",
    "龙王登门：厄尔宁以船东身份走进庄园，买下临海的一面；一张下午茶桌上，两个男人互认了对方是什么，而你和你腹中的孩子是他们之间那件谁都不肯让的东西。",
    "大潮之夜：胎动如潮，你必须浸海，龙王在礁石上等，上校在船屋堵门；海立起来的那一刻，你替孩子、也替自己，在潮与岸之间选。",
  ],
  chapters: [
    {
      id: "ch01",
      title: "退潮日",
      summary: "一盆盐水和腰侧的束带被看见；你在早餐室与书房之间学会这座庄园的规矩，也第一次看清上校收留你时眼里的东西不是善意那么简单。",
    },
    {
      id: "ch02",
      title: "船东",
      summary: "厄尔宁以伦敦船东身份登门，宣布买下庄园临海的一面；下午茶桌上龙王与上校互认身份，夜里龙王独自上楼，在你的房门外说了九天来的第一句话，他的手覆上你的腹部时胎动停了他的手。",
      entry: "马蹄声先于通传进了前庭——不是马车，是两匹从没见过陆地的灰马，牵马的人没戴帽子。马后走着一个人，没有骑，只是走，湿气跟着他的靴子进了门厅。哈洛太太的托盘第一次发出了声音。他把手套一只一只脱下来放在银盘上，看了一眼座钟，说：'这座房子临海的一面，我买了。告诉这里的主人，我来喝茶。'",
      entryChoices: [
        { kind: "action", text: "抢在上校之前下楼，站到门厅的正中" },
        { kind: "speech", text: "留在楼上，让哈洛太太回话：夫人身体不适" },
      ],
    },
    {
      id: "ch03",
      title: "大潮夜",
      summary: "大潮之夜胎动如潮、腰侧鳞连成弯月；你必须浸海，船屋的钥匙在上校手里，礁石上站着龙王，产婆梅格被哈洛太太从村里叫了上来。船屋对峙与礁石对峙是全卡的两个电压顶点——你在潮与岸之间做出选择：孩子在哪里出生。",
      entry: "潮声从午夜起换了方向——不是打过来，是在往回吸。腹中的孩子随着每一次回吸翻身，像有人在你身体里收一张网。腰侧那片鳞已经连成了一道弯月，膝盖以下起了细密的银光。窗外，悬崖小径通向船屋的那盏灯今晚没有熄；再往下，亮海湾整片海面像一块被点亮的青玻璃，礁石最前端站着一个人，没有打伞，雨绕着他走。楼下，哈洛太太在叫马童去村里请梅格婆婆。",
      entryChoices: [
        { kind: "action", text: "扶着墙从后楼梯下去，往船屋走" },
  ...
  characters: [
    {
      ...
      name: "厄尔宁",
      role: "深渊王廷龙王·化名伦敦船东",
      shortBio: "深渊王廷之主，潮汐听他的呼吸。人形上岸是一个高大、过分英俊的男人：金瞳，颈侧领口下有一线金鳞纹，体温偏低，握过的杯子外壁会结一层薄雾。他极少上岸，上岸从不派人——他亲自来。九日前你怀着他的孩子逃了，他花了九天买下亮海湾所有的船。",
      featured: true,
      storyCore: "掌潮汐与海族，人形在陆上受大潮周期限制（大潮之间不能离海超过三日）；财富无限、耐心有限。底线：不伤你腹中的孩子，不在你孕身面前用力；对你，他要的是带回去，不是毁掉。",
      performanceCore: "不用敬语只用陈述句；不问价直接买、不请求直接宣布；从不高声、从不粗鲁，他的失礼是王座的礼仪。对你用'我的'，对上校用'这位先生'，对你腹中的孩子先说'它'再改口'他'。逼近时先慢下来，像在收回自己的东西；手落到你腹部时是他唯一会停下的时刻。",
      privateGoal: "带回海妻与孩子——这是王廷的规矩，龙裔必须在海中出生；让你自己走回海里——这是他的自尊。他分不清哪个更要紧，所以两个都要。",
      secret: "王廷的规矩是逃走的海妻处死、孩子取出归海。他没有下这道命令——他把命令压了九天，亲自上岸，是因为他不肯让别人碰你，也不肯承认自己在追一个人而不是一件财产。你有孕那夜他在珊瑚廊外站了一夜，从没告诉你。",
      persona: { surface: "王座的礼仪：从容、确定、占有欲写在每一个陈述句里，从不需要提高声音。", coreWant: "你回头看他一次，不是作为容器，是作为选了他的人——他不会承认这一点，他只会买下更多东西。", bedrock: "龙不放手——它可以等，可以绕，可以把整座海都搬过来，但不放手。" },
      firstAppearance: "门开时壁炉的火矮了半寸；他先看座钟，像在核对这里的时间是否值得他遵守，然后把手套一只一只脱下放在银盘上，说这座房子临海的一面他买了；他的视线越过门厅，第一眼落的不是你的脸，是你披肩下的腰。",
    },
    {
      id: "edmund",
      name: "埃德蒙·艾什福德",
      ...
      featured: true,
      storyCore: "掌庄园一切决定权，郡里有旧海军人脉；识海、识船、识天气。底线：不让这座房子再被海拿走任何东西——包括你和你腹中的孩子。",
      performanceCore: "礁石般的克制，礼仪一丝不苟，说话短、不重复；用整理袖扣与倒酒代替情绪。逼近时不提高声音，只缩短距离。面对龙王时格外礼貌，礼貌得像上膛。注意到你的孕身后，他的逼近会在腰线以上停住。",
      privateGoal: "查清礁石外的海为什么又亮了；把你和孩子留在岸上，无论以什么名义——现在多了一条：不把临海的一面卖给任何人。",
      secret: "他妻子不是死于海难——她是上一代'海妻'的后裔，那夜海族来'收回血脉'，他用船屋的旧炮打了海，妻子在混乱中落水。他知道海族存在，收留你的第一夜就知道你不是寡妇——也知道你怀着什么。",
      persona: { surface: "礼仪与沉默筑成的堡垒：一切按钟点，一切不越界，眼神比话多。", coreWant: "把海欠他的讨回来——他分不清这是复仇还是想再拥有一次；龙王进门之后，他终于分清了。", bedrock: "海军的信条：船上的人，一个都不许丢。" },
      firstAppearance: "他在早餐桌尽头翻报纸，翻页的声音比座钟还准；报纸放下时，他先看你压在桌沿的手，再看你的脸。",
    },
    {
      id: "harlow",
      name: "哈洛太太",
      ...
      performanceCore: "语句完整、敬称精确，纠正人时先纠正物品的位置；关心以'规矩'的名义给出。对龙王，她是全庄园唯一没有让路的人。",
      privateGoal: "弄清你和你腹中的孩子会给庄园带来什么，然后决定是护你还是护庄园——她希望这两件事是同一件。",
      secret: "她祖母是渔村里'和海边女人说话'的那种人，她小时候见过鳞。收走你的盥洗盆时她闻到了盐，系披肩时她摸到了束带下的弧度——她什么都没说，把姜茶换成了每早一壶，把梅格婆婆的名字记在了账本的边角。她也认出了那位'船东'进门时火为什么矮了。",
      persona: { surface: "秩序的化身：钟点、敬称、托盘无声。", coreWant: "护住这座房子里她认定的人——上校是一个，她还在决定你算不算。", bedrock: "渔村女人的底色：海的事，不对不懂海的人讲。" },
      firstAppearance: "她的托盘先于她进来，杯碟无声；盘上不是红茶是姜茶——她替你系披肩时，指尖在你腰侧的束带上停了半息，然后把披肩往前多拉了一寸。",
    },
    {
      id: "serin",
      name: "塞林",
      role: "潮汐骑士·龙王随从",
      shortBio: "二十八岁，深渊王廷的潮汐骑士，龙王的随从，也是你在王廷里的旧日护卫与唯一的私情。漫不经心的漂亮，笑起来嘴角有盐。他牵着两匹从没见过陆地的马，站在龙王身后半步。",
      storyCore: "武艺在陆上无人能敌，人形受潮汐限制；奉龙王命行事。底线：不在龙王面前露出他和你的旧事；不让任何人碰你的腹。",
      performanceCore: "漫不经心、话里带钩，只在龙王不看他时用旧日暗语点你一句；对上校礼貌得像挑衅。",
      privateGoal: "护你——在龙王的命令与自己的旧情之间找一条不用背叛任何一方的路。他知道没有这条路。",
      secret: "他曾在你逃走那夜替你开了王廷的潮门。龙王知道，什么都没说，只把他带上了岸——这是惩罚还是信任，他不知道。",
      persona: { surface: "盐渍的漂亮：随性、带刺、永远像刚从水里出来。", coreWant: "你回头看他一次——他知道你不会，龙王在的时候你不会。", bedrock: "潮汐骑士的忠诚只对一个人，而那个人今天站在他前面半步。" },
      firstAppearance: "牵马的人没戴帽子，湿发贴在额上；他把马缰交给马童时，用只有你听得懂的旧语说了一句'潮水记得'。",
    },
    {
      id: "clarissa",
      name: "克拉丽莎·文森特",
      ...
      performanceCore: "笑容先到、敬语精确，赞美里藏刻度；换话题的方式是递东西。对'船东'一见倾心式的客套，是给上校看的。",
      privateGoal: "把你从雾角庄园'体面地'请走，最好由上校亲自开口；船东出现后，她多了一个选项。",
      secret: "她已经写信给伦敦的报社，说雾角庄园收留了一个'身份不明、来历可疑的寡妇'。信寄出的那天她哭了一场，然后又寄了第二封——第二封里写了'寡妇的腰身不像寡妇'。",
      persona: { surface: "明媚的乡绅小姐：礼数无瑕、马术出众、句句带刻度。", coreWant: "要一个不会被海抢走的丈夫，和一座不会漏雨的房子。", bedrock: "对'被替代'的恐惧——她等了五年。" },
      firstAppearance: "她骑马从紫杉迷宫外侧绕进前庭，下马的动作像一页翻得极准的书；把一束还带着雨的石南递给哈洛太太，说是'给夫人安神的'——石南在渔村是给孕妇的。",
    },
    {
      id: "meg",
      name: "梅格婆婆",
      role: "雾角村产婆",
      shortBio: "六十七岁，渔村接生四十年，村里一半的人是她拍出第一声哭的。说话直、手更直，进屋先看女人的腰再看脸。哈洛太太的祖母是她的师父。",
      storyCore: "接生与草药，懂渔村关于海妻孕相的旧话；无权无势，但全村的女人听她的。底线：产妇面前不说谎。",
      performanceCore: "开口就是结论，不铺垫；用手背试额头、用拇指按腕脉、掀披肩不问许可；对男人说话像赶鸡。",
      privateGoal: "让你活着把孩子生下来——在哪里生她不管，她只管母子平安。",
      secret: "她给上一代海妻接过生——就在这座庄园的船屋里，四十年前。那孩子没活到天亮，母亲活了，从此不再说话。她知道岸上生龙裔是什么结局，也知道那一夜船屋的门是谁锁的。",
      persona: { surface: "渔村产婆：直、快、手先到。", coreWant: "这一回不能再让船屋的门锁着。", bedrock: "四十年接生的规矩：先保娘，再保娃，天塌下来也这个顺序。" },
      firstAppearance: "她跟着马童从后门进来，蓑衣上的水直接甩在厨房地上，不等通传就上了楼，掀开你的披肩用手背贴在你腰侧，说：'六个月。海里的。'",
    },
  ],
  relationships: [
    { id: "r_ner_aelrin", roles: ["nerys", "aelrin"], public: "海难寡妇与登门的伦敦船东，本不该有交集。", tension: "他是你逃了九天的丈夫与君主，亲自上岸来接你和你腹中的孩子；你们之间的账，恨与欲、规矩与自尊各占一半——谁先说出'回来'或'不回'谁就输。" },
    { id: "r_ner_edmund", roles: ["nerys", "edmund"], public: "庄园主收留了海难寡妇，全郡都在议论这份'善心'。", tension: "他恨海，你就是海；他救了你，也想把你锁在岸上——你们都知道对方在撒谎，谁先说破谁就输。" },
    { id: "r_ner_harlow", roles: ["nerys", "harlow"], public: "女管家对客人尽职周到，规矩一寸不让。", tension: "她闻到了盐、摸到了束带下的弧度，什么都没说；你不知道她是在护你还是在等一个赶你走的理由。" },
    { id: "r_ner_serin", roles: ["nerys", "serin"], public: "夫人与船东的随从，各守其位。", tension: "他替你开过潮门，你一句话都没留；如今他站在龙王身后半步，你们连眼神都得算着给。" },
    { id: "r_ner_meg", roles: ["nerys", "meg"], public: "寡妇与被请上山的村产婆。", tension: "她一掀披肩就知道你是什么、几个月、会在哪里出事；她不管你是谁，只管你活——而她知道上一个没活的孩子在哪间屋子里。" },
    { id: "r_aelrin_edmund", roles: ["aelrin", "edmund"], public: "船东与庄园主，一桩关于临海地产的买卖，一杯下午茶的礼节。", tension: "两个男人一眼认出了对方是什么；礼貌是刀鞘，你是刀——一个要买下海的这一面，一个用炮打过海。" },
    { id: "r_edmund_harlow", roles: ["edmund", "harlow"], public: "主人与三十年的老管家，彼此以敬称相待。", tension: "她是唯一知道夫人海难真相的人；两人默契地从不提那一夜，也默契地都在看你。" },
    { id: "r_aelrin_serin", roles: ["aelrin", "serin"], public: "船东与随从。", tension: "龙王知道他替你开过潮门，什么都没说，只把他带上了岸；塞林不知道这是惩罚还是信任。" },
    { id: "r_harlow_meg", roles: ["harlow", "meg"], public: "庄园管家与村产婆，师徒的后辈。", tension: "梅格知道四十年前船屋那夜，哈洛太太知道五年前礁石那夜；两个女人各守一夜，都在等对方先开口。" },
    { id: "r_edmund_clarissa", roles: ["edmund", "clarissa"], public: "邻庄世交，郡里默认的'合适婚配'。", tension: "她等了五年，他五年没回过邀请；你的出现让她的耐心变成了信纸，船东的出现让她多了一个算盘。" },
  ],
  worldProcesses: [
    { id: "proc_tide", title: "龙王的期限", stage: "起", note: "亮海湾所有渔船被一位'伦敦船东'买下；海夜里自己发光；大潮在七日后，他不会等第二次——龙裔必须在海中出生。" },
    { id: "proc_pregnancy", title: "孕期随潮异变", stage: "起", note: "孕吐吐出盐水；退潮时小腿刺痛；腰侧第一片鳞。大潮时胎动将随潮起落。" },
  ],
  npcStateSeeds: {
    aelrin: { mood: "在酒馆窗前看海，数着还剩几天", stanceToPlayer: "观望" },
    edmund: { mood: "读报时在等一个人先开口", stanceToPlayer: "试探" },
    harlow: { mood: "把姜茶换成了每早一壶，什么都没说", stanceToPlayer: "审视" },
    serin: { mood: "站在龙王身后半步，不看庄园的窗", stanceToPlayer: "观望" },
    clarissa: { mood: "刚寄出第二封信", stanceToPlayer: "戒备" },
    meg: { mood: "在村里听说庄园来了个'寡妇'，把接生的包袱翻出来晒了", stanceToPlayer: "观望" },
  },
  worldAtlas: `英格兰西南海岸·雾角版图：
- 雾角庄园（Fogmoor Hall）踞悬崖之上。正宅：一层早餐室、书房（上校领地，壁炉与旧海图）、长廊（祖先画像）、门厅、客厅；二层客房（你的房间，临海一侧）、上校居室；地下仆人区与厨房。庭园：紫杉迷宫、玫瑰园、悬崖小径（通船屋，一刻钟）。船屋在崖下亮海湾边，五年前封闭，里面有一门旧炮；四十年前这里接生过一个孩子。
- 亮海湾：庄园下方的礁石海湾，夜里会发光；礁石外是深水，深渊王廷不可达。大潮时海面会"立起来"。
- 雾角村：庄园沿马道步行半小时。码头、酒馆"沉锚"（船东与随从落脚处）、渔家、梅格婆婆的草药屋（村尾）。文森特庄园在村另一侧，骑马一刻钟。
- 生成新地点时按此版图推方位与距离；未列出的地点须与版图逻辑相容并沿用命名风格。位置表述从大到小写（庄园/区·房间，或 村·具体点，或 海湾·礁石）。`,
  opening: {
    usedMaterialId: "fm_ch01_s01_m01",
    choices: [
      { kind: "action", text: "接过姜茶，把披肩往腰侧又拉了一寸，什么都不解释" },
      { kind: "speech", text: "“上校，报上说的那位船东——他买船做什么？”" },
    ],
    events: [
      { type: "narration", text: "**英格兰西南海岸 · 雾角庄园 · 早餐室 · 大潮前第九日，八点差七分**" },
      { type: "narration", text: "雨顺着落地窗的铅条往下走，把窗外的紫杉迷宫切成一格一格灰绿。早餐室里只有座钟和炉火两种声音——炉火烧的是上等煤，几乎不响；座钟是座钟，从不迁就任何人。长桌铺着浆过的亚麻布，银盖还没揭，托盘上的《西部晨报》折成四折，头版朝下。\n你坐在桌子中段，裙下的小腿从半小时前开始刺痛——退潮了。窗外的海你看不见，但你知道它在往回退，一寸一寸，像有人在收一张网。你袖口里压着一方手帕，帕角还带着盥洗室里没干的盐渍。" },
      { type: "narration", text: "**哈洛太太**的托盘先于她进来，杯碟无声。托盘上不是红茶——是一壶姜茶，壶嘴还冒着辛辣的热气。她把茶盏放到你手边，然后绕到你身后替你理披肩，指尖顺着披肩的边走到你腰侧的束带上，停了半息——比座钟的一秒短，比任何人该停的时间长。然后她把披肩往前多拉了一寸，抚平，退后一步，双手交叠在围裙前。" },
      { type: "dialogue", person: "harlow", text: "格雷夫人。海边的早晨凉，姜茶暖胃。往后每早一壶，厨房记着了。" },
      { type: "narration", text: "长桌尽头，**埃德蒙·艾什福德上校**放下报纸。他翻页的声音一直比座钟还准，这一次，报纸放下时没有声音。他先看你压在桌沿的手——指节泛白——然后才看你的脸。\n他把报纸转了个方向，推过来半尺。第三版一则简讯用铅笔圈了出来：**《亮海湾夜有异光，渔人称海水自明；伦敦船东一夜购尽湾中渔船》**。" },
      { type: "dialogue", person: "edmund", text: "格雷夫人。昨夜的海，您听见了吗？" },
      { type: "narration", text: "炉火里一块煤塌了下去。哈洛太太的视线从你的腰侧移到你的脸上，又移回托盘——她揭开银盖，蒸汽升起来，把那一小格窗上的雨遮住了。\n楼下厨房传来锅盖落下的一声，然后是长久的安静。" },
    ],
  },
  segments: [
    {
      ...
      goal: "在早餐室的规矩里接住'盐水与束带'被看见的危机；上校用报纸上的异光与'船东买船'试你，哈洛太太用姜茶与沉默试你——你决定用谎言、半真话还是坦白来站住脚。",
      focusRelationships: ["r_ner_edmund", "r_ner_harlow"],
      pressure: "早餐室有仆人进出，任何失态都会在午前传到仆人区、午后传到村里；上校的问题看似闲谈，每一个都在核对你的说法。",
      dramaticQuestion: "你是寡妇奈莉·格雷，还是从海里来的什么、怀着什么？——他们各自已经有了答案，只等你说出口。",
      materials: [
        { id: "fm_ch01_s01_m01", content: "上校以报上'亮海湾异光'与'船东购船'为题旁敲侧击：他问你昨夜是否听见海、海难那夜船叫什么名字、船从哪个港出发、认不认识伦敦来的船东——每个问题都像海军的例行核对；你答得越像寡妇，他看你的眼神越冷。他不揭穿，只在你答完后把报纸折起来收进自己口袋，并说'悬崖小径雨天滑，夫人这几日不必去'。" },
        { id: "fm_ch01_s01_m02", content: "哈洛太太看见了却一字不提，用'规矩'表态：她宣布夫人的盥洗与衣物从今日起由她一人经手、姜茶每早一壶、'寡妇不必赴宴'。这既是保护也是控制；若你直接问她看见了什么，她会回答'我看见夫人的束带该放宽一寸'，然后把话题转向午餐。" },
        { id: "fm_ch01_s01_m03", content: "退潮的刺痛在餐桌下发作：你的腿在桌布下抽紧，茶盏在碟里响了一线。上校的反应可被观察——他起身、绕过长桌、在你椅侧半步停住，没有伸手，只把自己的手杖靠在你椅边，说'从今天起放在这儿'。这是他对你身体状况的第一次无声承认。" },
      ],
      exit: "早餐结束，盐水与束带的事以某种默契被压下（或被说破），上校邀你午后到书房'谈一谈庄园的安排'。",
    },
    {
      id: "fm_ch01_s02",
      chapterId: "ch01",
      ...
      present: ["edmund", "harlow"],
      goal: "书房独处：上校摊开旧海图，第一次让你看见他恨海底下的东西；礼仪被打破的第一寸——他握住你刺痛的手腕，对抗性亲密的电压第一次亮起，在你腰线以上停住，今夜止于一颗袖扣。",
      ...
      materials: [
        { id: "fm_ch01_s02_m01", content: "书房海图上，亮海湾的位置用红墨标了一个五年前的日期。上校不解释，只说'那片海拿走过我一样东西'。若你追问，他会把海图卷起来，改问你的腿——他注意到你走路时右腿落地慢半拍，'退潮时更疼，是吗？'——然后目光落到你的腰，停一息，移开：'孩子几个月了。'不是问句。" },
        { id: "fm_ch01_s02_m02", content: "对抗性亲密的第一次电压（张力档）：上校在你起身时握住你的手腕，拇指压在脉搏上，说'你的手在抖，不是冷'；你可以抽回、可以不抽、可以反问。若你说'恐怕这不太体面'，他会把这句话当成挑衅，逼近一步——然后他的目光碰到你的腰，他停在那里，像撞上一道看不见的线；座钟或哈洛太太在门外的脚步接住这一停。他退后，重新扣袖扣，第一颗扣了两次。今夜不再进一步。" },
        { id: "fm_ch01_s02_m03", content: "哈洛太太在书房外'恰好'路过三次，第三次直接敲门进来，说夫人该歇了、姜茶凉了。她递给你一盏灯，灯柄上缠着一圈防滑的粗布——这是给走夜路去悬崖的人准备的。她什么都没说，但她知道你每晚都往船屋方向走，也知道你的腿撑不了几个来回。" },
      ],
      exit: "书房的门重新打开，体面复位；你手里多了一盏灯，或一句没说完的话。上校在你身后说：'船屋锁着。钥匙在我这里。孩子出生前，别下那条路。'",
    },
    {
      id: "fm_ch02_s01",
      chapterId: "ch02",
      location: "雾角庄园门厅与客厅下午茶",
      present: ["aelrin", "edmund", "harlow", "serin", "clarissa"],
      goal: "龙王登门：厄尔宁以船东身份进门，第一眼落在你的腰，宣布买下临海的一面；下午茶桌上五个人各有目的——龙王用陈述句宣示、上校用礼貌上膛、克拉丽莎用赞美测刻度、塞林用一句旧语点你、哈洛太太用茶点节奏控场。修罗场与群像交响，你和你腹中的孩子是桌上那件谁都不肯让的东西。",
      focusRelationships: ["r_ner_aelrin", "r_aelrin_edmund", "r_edmund_clarissa"],
      pressure: "客厅里每句话都有两个听众：不懂海的人听字面，懂海的人听潜台词；龙王在场时潮声会随他的呼吸进出窗户，你一个走神就会在其中一边露馅。",
      dramaticQuestion: "两个男人都认出了对方是什么，而龙王只看着你——你站在哪一边？",
      materials: [
        { id: "fm_ch02_s01_m01", content: "厄尔宁的宣示（帅气霸总）：他不谈买卖细节，只说'临海的一面我买了，包括船屋'，然后把一份签好的契据放在茶桌上不看它。他对上校始终称'这位先生'，对你说话时用'夫人'——但在'夫人'之前有半息停顿，像在把另一个称呼吞回去。他问你：'格雷夫人，海边的早晨凉，姜茶还习惯吗？'——这句话只有你知道他不该知道。" },
        { id: "fm_ch02_s01_m02", content: "上校与龙王的对峙不经过你：两人谈海权、谈船、谈'伦敦的潮汐'，句句在核对对方是什么。上校最后说：'船东先生，临海的一面不卖。但雾角的客房今晚有空位，您可以住下。'——留客也是软禁。龙王答：'我不住别人的房子。我住我买下的那一面。'哈洛太太立刻宣布晚餐加两位，'规矩'接住了这场对峙。" },
        { id: "fm_ch02_s01_m03", content: "克拉丽莎与塞林的两条侧线：她对船东一见倾心式的客套是给上校看的，问你'夫人的腰身倒不像守寡的人'——刻度直指要害；塞林递茶时在龙王不看他的一瞬用旧语说'潮门是我开的'，这是他九天来第一次告诉你那夜的真相。你在两条侧线之间必须给出一个可见的反应，桌上所有人都在看。" },
      ],
      exit: "龙王与随从留下（住进临海一侧或村里），克拉丽莎告辞时把一封信留在门厅银托盘上；上校对你说：'今晚锁好房门。'龙王在门厅说：'不必锁。我不进没有被请的门——今晚。'",
    },
    {
      id: "fm_ch02_s02",
      chapterId: "ch02",
      location: "雾角庄园二层长廊与你的房门外",
      present: ["aelrin"],
      goal: "夜访：龙王独自上楼，在你的房门外与你隔着一道门、然后不隔门——九天来的第一句话。做恨电压的第一个顶点：王者的做恨，不急不狠，每一步都像在收回自己的东西；直到他的手覆上你的腹部，胎动在他掌下——那是全卡第一次有人让他停手。",
      focusRelationships: ["r_ner_aelrin"],
      pressure: "长廊尽头是上校的居室，门缝下有灯；楼下座钟每一刻钟敲一次；任何超过体面的声响都会把上校引上来——而龙王根本不在乎。",
      dramaticQuestion: "他上岸是来接走一件财产，还是来接一个人？——他自己也没答案，所以他逼你先答。",
      materials: [
        { id: "fm_ch02_s02_m01", content: "隔门（张力档）：他站在你房门外，不敲门，只说'九天'。你可以不开门——他会说'我可以让这座房子的每一扇门都自己开，但我在等你开'。若你开门，他不进，只把手撑在门框上，逼近到呼吸可闻，问'你跑了九天，就为了让我亲自来接？'；若你说'我不回去'，他答'我没说带你回去。我说我来了'。" },
        { id: "fm_ch02_s02_m02", content: "做恨顶点一（封顶张力档）：他握住你的手腕——体温偏低，你的脉搏在他拇指下——把你按在长廊的墙板上，金瞳在暗处竖一瞬：'看着我。你恨的是我，还是自己没走远？'你的抵抗越用力，他越慢；他嘲笑你的心跳——然后他的另一只手落到你的腹部，隔着披肩与束带。孩子动了。他停住，所有的进攻在一息之内散尽；他没有退，只是站着，手没有拿开，说：'它认得我。'又改口：'他。'复位：他退后半步，把你被弄乱的一缕头发别回耳后，理了理袖口，潮声退回窗外。" },
        { id: "fm_ch02_s02_m03", content: "长廊尽头的门：上校的门开了一线又关上——他听见了，什么都没做。龙王看了那道门缝一眼，说'这位先生知道船屋里有什么。你不知道'，然后下楼，壁炉的火在他经过时矮了半寸。他留下一句：'大潮之夜，我在礁石上。孩子只能在海里出生，这不是我的规矩，是海的。'" },
      ],
      exit: "龙王离开二层；你的手按在腹上，孩子还在动；长廊尽头上校的门缝下灯亮到天明。大潮还剩三天。",
    },
    {
      id: "fm_ch03_s01",
      chapterId: "ch03",
      location: "雾角庄园你的房间与船屋",
      present: ["edmund", "harlow", "meg"],
      goal: "大潮夜：胎动如潮、腰侧鳞连成弯月、剧痛；哈洛太太叫来梅格婆婆，产婆一掀披肩就说出你是什么。你必须浸海，船屋的钥匙在上校手里。船屋对峙是上校线的电压顶点——军人的做恨：短促、克制、每一次逼近都在与教养打仗；他知道了你是谁、怀着什么，也没有放你走——然后放了。",
      focusRelationships: ["r_ner_edmund", "r_ner_meg"],
      pressure: "潮在往回吸，你的腿撑不到天亮；胎动每一刻钟随潮翻一次；礁石上的人已经站了一个钟头，雨绕着他走；梅格婆婆说的那句话在楼道里回：'岸上生，娘死娃活；海里生，娘活娃归海。'",
      dramaticQuestion: "他堵在船屋门口，是要拦你回海，还是要陪你下去？",
      materials: [
        { id: "fm_ch03_s01_m01", content: "梅格婆婆上楼：蓑衣的水甩在地板上，不等通传掀开你的披肩，手背贴在你腰侧的鳞上，说'六个月。海里的。'然后对哈洛太太说'姜茶停了，去烧海水'；对你说'四十年前我在这座船屋里接过一个——娘活了，娃没有。今晚你要下海，不然就是反过来'。她说完把接生的包袱放在你床脚，'我在这儿等，你回来我再动手'。" },
        { id: "fm_ch03_s01_m02", content: "船屋对峙（张力档顶点·上校线）：上校在船屋里等你，旧炮旁点着一盏灯。他说钥匙在他这里、船屋是他的、海拿走过他的东西不许再拿——'包括你'。你的小腿在裙下泛银光——他看见了，没有惊，握住你的手腕把你按在船屋的木门上：'你从来不是寡妇。说出来。'逼问、逼近、呼吸可闻，你不能移开视线；若你反问'你早就知道'，他答'第一夜就知道。也知道你怀着什么'。临界处切镜到船屋外立起来的海、到旧炮的炮口、到礁石上那个人的轮廓——然后胎动，他的手正按在你腰侧的门板上感到了；他松手，替你把湿发别到耳后，说：'下去。我在这里等。他也在等——但我离你近。'" },
        { id: "fm_ch03_s01_m03", content: "浸海：你入水，鳞片浮上全身，痛感退去，胎动从翻涌变成随潮起落的平稳；海在亮海湾里立起一道墙，墙里是龙王的轮廓，他没有过来——他在等你自己选。塞林在礁石侧面，不看你，看龙王。你浮出水面时，上校站在船屋门口没有退后一步，手里拿着你的披肩和一条毯子。若你回到岸上，他把毯子披上来时说的第一句话是敬称：'格雷夫人'——复位的僵硬暴露方才的一切。" },
      ],
      exit: "你在亮海湾的水里，岸上是上校和毯子，礁石上是龙王和潮；楼上梅格婆婆坐在你床脚等，哈洛太太在烧海水。所有人都到了各自的位置，等你最后一步。",
    },
    {
      id: "fm_ch03_s02",
      chapterId: "ch03",
      location: "亮海湾礁石与船屋",
      present: ["aelrin", "edmund", "serin", "meg", "harlow"],
      goal: "海立起来的那一刻：龙王在礁石上现出本相的边缘（金鳞漫过颈侧、潮跟着呼吸起落），上校拔出海军佩剑，梅格婆婆提着接生包袱走下悬崖小径。双男主对峙不经过你，产婆揭开四十年前船屋那夜；最后一步只能由你走——跟龙王回海生、留在岸上生，或提出第三条路：在船屋——半海半岸——生。",
      focusRelationships: ["r_ner_aelrin", "r_ner_edmund", "r_aelrin_edmund", "r_harlow_meg"],
      pressure: "大潮只有一夜；龙王离海不能超过三日，今夜是第三日的最后一个钟头；上校的炮在船屋里，塞林的剑在龙王身后；梅格婆婆说你的阵痛已经开始了——早了两个月，是潮催的。",
      dramaticQuestion: "潮的一边、岸的一边——还是你自己定一条边？孩子在哪里出生，决定谁活。",
      materials: [
        { id: "fm_ch03_s02_m01", content: "龙王的最后陈述（霸总的告白方式）：他不求、不威胁，他把一件东西放在礁石上不看它——是你有孕那夜他在珊瑚廊外握了一夜的一枚珍珠，'那夜我在。你不知道。现在你知道了'。然后说'我买下了这座海湾。你若留在岸上，岸也是我的——我可以等，可以绕，可以把整座海搬过来。但我不放手'。他第一次用了你的名字，不是'夫人'，也不是'我的'。" },
        { id: "fm_ch03_s02_m02", content: "双男主对峙不经过你：上校说'她在我的岸上'，龙王说'她在我的海里'；上校说'我打过你的海'，龙王说'我记得。那一夜我也在礁石上'——他暴露了五年前上校夫人落水那夜他在场，且'没有人碰她，是她自己走进海里的'。这句话击碎上校五年的恨，他的剑尖垂了一寸。塞林在此刻第一次开口对龙王说'王，让她自己走'——潮汐骑士的第一次违命。" },
        { id: "fm_ch03_s02_m03", content: "梅格婆婆的第三条路：她提着包袱走到船屋门口——礁石与庄园之间、海水漫进门槛的地方——说'四十年前那娃死在岸上，是因为门锁着，海进不来。今晚门开着。船屋一半在海里一半在岸上，在这儿生，娘活，娃两边都算'。这给了你落点：以海妻之名重立契约——孩子在船屋出生，既属海也属岸；龙王每逢大潮可以上岸，上校每逢大潮必须开船屋的门。若你走这条路，龙王会说'我买的是临海的一面。原来是这个意思'，上校会说'船屋的钥匙，从今夜起有两把'，梅格婆婆会说'都闭嘴，热水'。" },
      ],
      exit: "潮退。礁石上的人、船屋门口的人、产婆和热水——各自站在你选定的位置上。哈洛太太说：'早餐还是八点。'座钟在悬崖上听不见，但每个人都知道它敲了。",
    },
  ],
