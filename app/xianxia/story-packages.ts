...
【西幻龙王感与霸总做派】龙王厄尔宁上岸时是人形，但世界要为他让路：他进门时潮声换方向、壁炉的火矮半寸、银器发出细微的共振；金瞳在暗处竖一瞬，颈侧金鳞纹在领口下若隐若现，体温偏低，握过的杯子外壁结一层薄雾。他不用敬语，只用陈述句——不问价直接买、不请求直接宣布、把整座庄园的规矩当作可以随手翻阅的东西，却从不高声、从不粗鲁：他的失礼是另一种礼仪，是王座的礼仪。对你用"我的"，对上校用"这位先生"，对塔莉用她真正的名字。霸总感来自绝对的确定与从容的占有欲，不来自吼叫或炫富；他最锋利的动作是把一件昂贵的东西放在你面前然后不看它。

【电压：激情做恨——只在对抗性亲密的独处场景启用，且封顶张力档】适用条件：两人身份对立（恨海的人与来自海的人；龙王与逃走的海妻），且现场无第三人。启用后写法：性张力写成一场谁先认输的战争——身体先于言语（抓握手腕、抬起下巴、把人按在门板或书桌边、逼近到呼吸可闻、不许对方移开视线），对白以反问与逼问为主、锋利直白、带嘲讽与掌控（"承认吧""你在发抖""你跑了九天，就为了让我亲自来接？"），嘲笑对方的动情反应，强调"你输了"。羞耻与渴望必须同框，用否定意志来凸显身体的诚实。龙王的做恨是王者的：不急、不狠、每一步都像在收回自己的东西；上校的做恨是军人的：短促、克制、每一次逼近都在与自己的教养打仗。张力档封顶：可写抓握、逼近、体温、呼吸、咬唇、失神一瞬、衣料摩擦与被按住的手腕，不写性行为过程与器官；镜头在临界处切走（换镜头到座钟、窗外的潮声、被撞歪的相框）。
...
【白描铁律】只写镜头拍得到、话筒录得到的：动作、位置、光影、声音、可见的神态。禁止心理转述（"她想起""他意识到"一律违规，内心走os气泡）、禁止隐喻与煽情形容词堆叠（"仿佛""宛如""某种"慎用）、禁止总结与升华。玩家的原话不得以旁白形式复述——玩家说过的话只作为已发生的事实被他人回应。
...
【感官先行与群像内核】每段单一主导感官领起（触觉或听觉优先），气味温度有来源有落点；同一回合相近意象不重复。人物带各自目标入画、动作改变谈话而非装饰谈话；哈洛太太的秩序感底下是护短，不写成刻薄管家；塞林的漫不经心是盐渍的伤口，不写成纯反派；塔莉是四岁的孩子，说四岁的话；克拉丽莎的刻度底下是怕被替代的少女。
...
const fogmoor: XianxiaStory = {
  ...
  title: "雾角海妻",
  subtitle: "潮汐篇",
  logline: "一个从深渊王廷逃出来的人鱼，抱着龙王的孩子叩响了一座恨海的庄园的门；庄园主收留了她——然后龙王亲自上岸，买下了这座庄园临海的一面。",
  accent: "#7f97a6",
  playerRole: {
    id: "nerys",
    name: "奈莉丝",
    ...
    freeAgency: "你可以决定对上校坦白多少、如何面对亲自上岸的龙王、要不要让塔莉长成一条龙，以及在大潮之夜站在潮的一边、岸的一边，还是两者之间。",
  },
  introduction: {
    time: "维多利亚时代晚期，秋末，大潮前的第九日",
    place: "英格兰西南海岸，悬崖上的雾角庄园",
    world: "陆上人早已不信海族，只有沿海的老人还记得'海妻'——古老家族与海族的旧契约：娶一位海妻，换一代人的风平浪静。雾角庄园的艾什福德家曾是签过契约的家族之一。海底另有一套秩序：深渊王廷统治潮汐，龙王厄尔宁的血脉只能借海族之外的躯体延续，海妻是容器，孩子是王廷的财产。龙王极少上岸——他上岸时，潮汐会跟着他走。",
    situation: "九日前的暴风夜，你抱着高烧的塔莉叩响了雾角庄园的门。埃德蒙·艾什福德上校——退役皇家海军、五年前丧妻于海难、全郡都知道他恨海——收留了你，以'海难寡妇奈莉·格雷'的身份。今晨退潮，你的小腿开始刺痛；哈洛太太替塔莉系围嘴时，手在她肩胛上停了半息。上校在读报，报上说礁石外的海昨夜'自己亮了'。而村里的酒馆住进了一位从伦敦来的'船东'，带着一个不戴帽子的随从，出手买下了亮海湾所有渔家的船。",
    objective: "先在庄园的规矩里站稳，别让第一片鳞把你和塔莉逐出这道门；再弄清上校为什么收留你——他看你的眼神不像看一个寡妇。大潮在七天后，你得决定到时候去浸海还是让鳞片浮上来；而那位买下所有船的'船东'，你不必见到就知道他是谁——他从不派人来接，他亲自来。",
  },
  threeAct: [
    "藏身与规矩：你在英式庄园的秩序里藏一个正在长鳞的孩子，上校的克制与你的警觉互相试探——他恨海，而你就是海。",
    "龙王登门：厄尔宁以船东身份走进庄园，买下临海的一面；一张下午茶桌上，两个男人互认了对方是什么，而你是他们之间那件谁都不肯让的东西。",
    "大潮之夜：你必须浸海，龙王在礁石上等，上校在船屋堵门；海立起来的那一刻，你替塔莉、也替自己，在潮与岸之间选。",
  ],
  chapters: [
    {
      id: "ch01",
      title: "退潮日",
      summary: "第一片鳞被看见；你在早餐室与书房之间学会这座庄园的规矩，也第一次看清上校收留你时眼里的东西不是善意那么简单。",
    },
    {
      id: "ch02",
      title: "船东",
      summary: "厄尔宁以伦敦船东身份登门，宣布买下庄园临海的一面；下午茶桌上龙王与上校互认身份，夜里龙王独自上楼，在育儿室门口与你隔着一道门说了九天来的第一句话。",
    ...
    },
    {
      id: "ch03",
      title: "大潮夜",
      summary: "大潮之夜塔莉高烧、鳞连成弯月；你必须浸海，船屋的钥匙在上校手里，礁石上站着龙王。船屋对峙与礁石对峙是全卡的两个电压顶点——你在潮与岸之间做出选择。",
      entry: "潮声从午夜起换了方向——不是打过来，是在往回吸。塔莉的额头烫得像壁炉边的铁架，肩胛上那片鳞已经连成了一道弯月。你的小腿在被单下抽紧，膝盖以下起了细密的银光。窗外，悬崖小径通向船屋的那盏灯今晚没有熄；再往下，亮海湾整片海面像一块被点亮的青玻璃，礁石最前端站着一个人，没有打伞，雨绕着他走。",
      entryChoices: [
  ...
  characters: [
    {
      ...
      name: "厄尔宁",
      role: "深渊王廷龙王·化名伦敦船东",
      shortBio: "深渊王廷之主，潮汐听他的呼吸。人形上岸是一个高大、过分英俊的男人：金瞳，颈侧领口下有一线金鳞纹，体温偏低，握过的杯子外壁会结一层薄雾。他极少上岸，上岸从不派人——他亲自来。九日前你抱着他的孩子逃了，他花了九天买下亮海湾所有的船。",
      featured: true,
      storyCore: "掌潮汐与海族，人形在陆上受大潮周期限制（大潮之间不能离海超过三日）；财富无限、耐心有限。底线：不伤塔莉，不在孩子面前失态；对你，他要的是带回去，不是毁掉。",
      performanceCore: "不用敬语只用陈述句；不问价直接买、不请求直接宣布；从不高声、从不粗鲁，他的失礼是王座的礼仪。对你用'我的'，对上校用'这位先生'，对塔莉用她真正的名字。逼近时先慢下来，像在收回自己的东西。",
      privateGoal: "带回海妻与孩子——这是王廷的规矩；让你自己走回海里——这是他的自尊。他分不清哪个更要紧，所以两个都要。",
      secret: "王廷的规矩是逃走的海妻处死、孩子归海。他没有下这道命令——他把命令压了九天，亲自上岸，是因为他不肯让别人碰你，也不肯承认自己在追一个人而不是一件财产。塔莉出生那夜他守了一夜，从没告诉你。",
      ...
      firstAppearance: "门开时壁炉的火矮了半寸；他先看座钟，像在核对这里的时间是否值得他遵守，然后把手套一只一只脱下放在银盘上，说这座房子临海的一面他买了。",
    },
    {
      id: "edmund",
      name: "埃德蒙·艾什福德",
      ...
      performanceCore: "礁石般的克制，礼仪一丝不苟，说话短、不重复；用整理袖扣与倒酒代替情绪。逼近时不提高声音，只缩短距离。面对龙王时格外礼貌，礼貌得像上膛。",
    ...
    },
    {
      ...
      secret: "她祖母是渔村里'和海边女人说话'的那种人，她小时候见过鳞。系围嘴时她看见了塔莉肩胛上的那一片，她什么都没说，把育儿室壁炉的煤加了一倍。她也认出了那位'船东'进门时火为什么矮了。",
    ...
    },
    {
      ...
      storyCore: "武艺在陆上无人能敌，人形受潮汐限制；奉龙王命行事。底线：不当着孩子的面动手；不在龙王面前露出他和你的旧事。",
    ...
    },
    {
      ...
      performanceCore: "说四岁的话：短句、重复、突然的问题；害怕时不出声，只找妈妈的裙角；好奇时会直接问大人不敢问的事。见到厄尔宁时不怕，她盯着他的眼睛看。",
      privateGoal: "想让妈妈不再夜里不睡；想知道'海在讲话'是不是坏事。",
      secret: "她能听懂海说的话，而海在叫她回家。她以为那是妈妈的声音——直到厄尔宁进门那天，她发现那是另一个声音。",
  ...
  relationships: [
    { id: "r_ner_aelrin", roles: ["nerys", "aelrin"], public: "海难寡妇与登门的伦敦船东，本不该有交集。", tension: "他是你逃了九天的丈夫与君主，亲自上岸来接；你们之间的账，恨与欲、规矩与自尊各占一半——谁先说出'回来'或'不回'谁就输。" },
    ...
    { id: "r_ner_tally", roles: ["nerys", "tally"], public: "母女。", tension: "你带她逃是为了不让她归海；她却在夜里听海讲话——厄尔宁进门那天，她盯着他的眼睛没有怕。" },
  ...
  worldProcesses: [
    { id: "proc_tide", title: "龙王的期限", stage: "起", note: "亮海湾所有渔船被一位'伦敦船东'买下；海夜里自己发光；大潮在七日后，他不会等第二次。" },
...
- 雾角庄园（Fogmoor Hall）踞悬崖之上。正宅：一层早餐室、书房（上校领地，壁炉与旧海图）、长廊（祖先画像）、门厅、客厅；二层育儿室（火不许灭）、客房、上校居室；地下仆人区与厨房。庭园：紫杉迷宫、玫瑰园、悬崖小径（通船屋，一刻钟）。船屋在崖下亮海湾边，五年前封闭，里面有一门旧炮。
- 亮海湾：庄园下方的礁石海湾，夜里会发光；礁石外是深水，深渊王廷不可达。大潮时海面会"立起来"。
- 雾角村：庄园沿马道步行半小时。码头、酒馆"沉锚"（船东与随从落脚处）、渔家。文森特庄园在村另一侧，骑马一刻钟。
  ...
  segments: [
    {
      ...
      goal: "在早餐室的规矩里接住第一片鳞被看见的危机；上校用报纸上的异光与'船东买船'试你，哈洛太太用沉默试你——你决定用谎言、半真话还是坦白来站住脚。",
      ...
      materials: [
        { id: "fm_ch01_s01_m01", content: "上校以报上'亮海湾异光'与'船东购船'为题旁敲侧击：他问你昨夜是否听见海、海难那夜船叫什么名字、船从哪个港出发、认不认识伦敦来的船东——每个问题都像海军的例行核对；你答得越像寡妇，他看你的眼神越冷。他不揭穿，只在你答完后把报纸折起来收进自己口袋。" },
    ...
    },
    {
      ...
      goal: "书房独处：上校摊开旧海图，第一次让你看见他恨海底下的东西；礼仪被打破的第一寸——他握住你刺痛的手腕，对抗性亲密的电压第一次亮起，但今夜止于一颗袖扣。",
    ...
    },
    {
      ...
      goal: "龙王登门：厄尔宁以船东身份进门，宣布买下临海的一面；下午茶桌上五个人各有目的——龙王用陈述句宣示、上校用礼貌上膛、克拉丽莎用赞美测刻度、塞林用一句旧语点你、哈洛太太用茶点节奏控场。修罗场与群像交响，你是桌上那件谁都不肯让的东西。",
      ...
      materials: [
        { id: "fm_ch02_s01_m01", content: "厄尔宁的宣示（帅气霸总）：他不谈买卖细节，只说'临海的一面我买了，包括船屋'，然后把一份签好的契据放在茶桌上不看它。他对上校始终称'这位先生'，对你说话时用'夫人'——但在'夫人'之前有半息停顿，像在把另一个称呼吞回去。他问你：'格雷夫人，您的孩子怕火，是吗？'——这句话只有你知道他不该知道。" },
        { id: "fm_ch02_s01_m02", content: "上校与龙王的对峙不经过你：两人谈海权、谈船、谈'伦敦的潮汐'，句句在核对对方是什么。上校最后说：'船东先生，临海的一面不卖。但雾角的客房今晚有空位，您可以住下。'——留客也是软禁，他把龙王放在眼皮底下。龙王答：'我不住别人的房子。我住我买下的那一面。'哈洛太太立刻宣布晚餐加两位，'规矩'接住了这场对峙。" },
        { id: "fm_ch02_s01_m03", content: "克拉丽莎与塞林的两条侧线：她对船东一见倾心式的客套是给上校看的，问你'与船东先生是旧识？'——刻度直指要害；塞林递茶时在龙王不看他的一瞬用旧语说'潮门是我开的'，这是他九天来第一次告诉你那夜的真相。你在两条侧线之间必须给出一个可见的反应，桌上所有人都在看。" },
      ],
      exit: "龙王与随从留下（住进船屋方向的东翼或村里），克拉丽莎告辞时把一封信留在门厅银托盘上；上校对你说：'今晚锁好育儿室的门。'龙王在门厅说：'不必锁。我不进没有被请的门——今晚。'",
    },
    {
      id: "fm_ch02_s02",
      chapterId: "ch02",
      location: "雾角庄园二层长廊与育儿室门外",
      present: ["aelrin", "tally"],
      goal: "夜访：龙王独自上楼，在育儿室门口与你隔着一道门、然后不隔门——九天来的第一句话。做恨电压的第一个顶点：王者的做恨，不急不狠，每一步都像在收回自己的东西；塔莉在门内醒着，她认出了那个声音。",
      focusRelationships: ["r_ner_aelrin", "r_ner_tally"],
      pressure: "长廊尽头是上校的居室，门缝下有灯；楼下座钟每一刻钟敲一次；任何超过体面的声响都会把上校引上来——而龙王根本不在乎。",
      dramaticQuestion: "他上岸是来接走一件财产，还是来接一个人？——他自己也没答案，所以他逼你先答。",
      materials: [
        { id: "fm_ch02_s02_m01", content: "隔门（张力档）：他站在育儿室门外，不敲门，只说'九天'。你可以不开门——他会说'我可以让这座房子的每一扇门都自己开，但我在等你开'。若你开门，他不进，只把手撑在门框上，逼近到呼吸可闻，问'你跑了九天，就为了让我亲自来接？'；若你说'我不回去'，他答'我没说带你回去。我说我来了'。" },
        { id: "fm_ch02_s02_m02", content: "做恨顶点一（封顶张力档）：他握住你的手腕——体温偏低，你的脉搏在他拇指下——把你按在长廊的墙板上，金瞳在暗处竖一瞬：'看着我。你恨的是我，还是自己没走远？'你的抵抗越用力，他越慢；他嘲笑你的心跳，然后在临界处松手——不是因为你挣脱，是因为门内塔莉叫了一声'妈妈'。他退后半步，把你被弄乱的一缕头发别回耳后，说'她叫你的时候，你从不看别的地方。很好'。复位：他理了理袖口，潮声退回窗外。" },
        { id: "fm_ch02_s02_m03", content: "塔莉开门：她站在门内，没有怕，盯着他的眼睛说'是你在讲话。海里的那个'。龙王第一次蹲下来——王者屈膝——用她真正的名字叫她，问她'海讲的话，你听懂了多少'。塔莉答'它说回家'，然后转头问你'妈妈，家是哪里'。龙王没有替你答，他站起来，说'大潮之夜，我在礁石上等你们两个人的答案'，然后下楼，壁炉的火在他经过时矮了半寸。" },
      ],
      exit: "龙王离开二层；塔莉抱着你的腿问'家是哪里'；长廊尽头上校的门开了一线又关上——他听见了，什么都没做。大潮还剩三天。",
    },
    {
      id: "fm_ch03_s01",
      chapterId: "ch03",
      ...
      goal: "大潮夜：塔莉发烧、鳞连成弯月；你必须浸海，船屋的钥匙在上校手里。船屋对峙是上校线的电压顶点——军人的做恨：短促、克制、每一次逼近都在与教养打仗；他知道了你是谁，也没有放你走——然后放了。",
      focusRelationships: ["r_ner_edmund", "r_ner_tally"],
      pressure: "潮在往回吸，你的腿撑不到天亮；塔莉的体温每一刻钟升一度；礁石上的人已经站了一个钟头，雨绕着他走。",
      dramaticQuestion: "他堵在船屋门口，是要拦你回海，还是要陪你下去？",
      materials: [
        { id: "fm_ch03_s01_m01", content: "育儿室：塔莉高烧，肩胛的鳞蔓延成一道弯月并泛出微光，她把耳朵贴在墙上说'他在叫我'——不是海，是他；哈洛太太守在门口，第一次直接说：'夫人，您该去海边了。孩子交给我。我祖母教过我怎么退烧——用海水。'她把育儿室的门从里面锁上，把你推向后楼梯。" },
        { id: "fm_ch03_s01_m02", content: "船屋对峙（张力档顶点·上校线）：上校在船屋里等你，旧炮旁点着一盏灯。他说钥匙在他这里、船屋是他的、海拿走过他的东西不许再拿——'包括你'。你的小腿在裙下泛银光——他看见了，没有惊，握住你的手腕把你按在船屋的木门上：'你从来不是寡妇。说出来。'逼问、逼近、呼吸可闻，你不能移开视线；若你反问'你早就知道'，他答'第一夜就知道'。临界处切镜到船屋外立起来的海、到旧炮的炮口、到礁石上那个人的轮廓——然后他松手，替你把湿发别到耳后，说：'下去。我在这里等。他也在等——但我离你近。'" },
        { id: "fm_ch03_s01_m03", content: "浸海：你入水，鳞片浮上全身，痛感退去；海在亮海湾里立起一道墙，墙里是龙王的轮廓，他没有过来——他在等你自己选。塞林在礁石侧面，不看你，看龙王。你浮出水面时，上校站在船屋门口没有退后一步，手里拿着你的裙子和一条毯子。若你回到岸上，他把毯子披上来时说的第一句话是敬称：'格雷夫人'——复位的僵硬暴露方才的一切。" },
      ],
      exit: "你在亮海湾的水里，岸上是上校和毯子，礁石上是龙王和潮；塔莉在育儿室退烧，哈洛太太在门内。所有人都到了各自的位置，等你最后一步。",
    },
    {
      id: "fm_ch03_s02",
      chapterId: "ch03",
      location: "亮海湾礁石与悬崖",
      present: ["aelrin", "edmund", "serin", "tally", "harlow"],
      goal: "海立起来的那一刻：龙王在礁石上现出本相的边缘（金鳞漫过颈侧、潮跟着呼吸起落），上校拔出海军佩剑，哈洛太太抱着退烧的塔莉站在悬崖小径上。双男主对峙不经过你，最后一步只能由你走——交出塔莉、跟龙王回去、留在岸上，或提出第三条路：两界之间。",
      focusRelationships: ["r_ner_aelrin", "r_ner_edmund", "r_aelrin_edmund"],
      pressure: "大潮只有一夜；龙王离海不能超过三日，今夜是第三日的最后一个钟头；上校的炮在船屋里，塞林的剑在龙王身后。",
      dramaticQuestion: "潮的一边、岸的一边——还是你自己定一条边？",
      materials: [
        { id: "fm_ch03_s02_m01", content: "龙王的最后陈述（霸总的告白方式）：他不求、不威胁，他把一件东西放在礁石上不看它——是塔莉出生那夜他守了一夜时握过的一枚珍珠，'她出生那夜我在。你不知道。现在你知道了'。然后说'我买下了这座海湾。你若留在岸上，岸也是我的——我可以等，可以绕，可以把整座海搬过来。但我不放手'。他第一次用了你的名字，不是'夫人'，也不是'我的'。" },
        ...
        { id: "fm_ch03_s02_m03", content: "塔莉的选择先于你的：她从哈洛太太怀里下来，走到礁石与船屋之间的沙上站住，说'我要妈妈。这里。'——她指的是两边之间的那块沙。这给了你第三条路的落点：以海妻之名重立契约——不归海也不归岸，雾角庄园临海的一面成为两界之间的地方，塔莉七岁前每逢大潮浸海一夜、其余时间在岸上长大；龙王每逢大潮可以上岸，上校每逢大潮必须开船屋的门。若你走这条路，龙王会说'我买的是临海的一面。原来是这个意思'，上校会说'船屋的钥匙，从今夜起有两把'。" },
      ],
      exit: "潮退。礁石上的人、船屋门口的人、沙上的孩子——各自站在你选定的位置上。哈洛太太说：'早餐还是八点。'座钟在悬崖上听不见，但每个人都知道它敲了。",
    },
  ],
